                    ...
                    <div class='relative group '>
                        <a href="<?php echo $page['url'] ?>">
                            ...
                            <div class='bg-white relative h-full group-hover:bg-black relative overflow-hidden p-2 rounded rounded-lg z-10 shadow shadow-lg text-center'>
                                <img class="group-hover:scale-105 transform  transition duration-300 ease-in-out  rounded rounded-lg" src="<?php echo $image['url'] ?>" alt="<?php echo $image['alt'] ?>">
                                ...
                                <span class="block w-full absolute rounded rounded-lg block  left-0 bottom-0 mb-4 text-white text-center"><?php echo $page['title'] ?></span>
                            </div>
