...
<section class="fw h-screen relative z-10 leading-normal" style="background:url() no-repeat; background-attachment: scroll;
    ...
    <img loading="lazy" class="object-cover w-full h-full absolute z-20" src="<?php echo get_template_directory_uri() ?>/assets/img/bedx.jpg" alt="" title="wp3704688">
    ...
    <div class="container mx-auto px-4 text-white font-semibold h-full flex items-center relative z-40">
        <div class="grid gap-6 lg:grid-cols-3 flex items-center">
            <div class="lg:col-span-2">
                ...
                <h1 class="text-3xl lg:text-6xl font-bold mb-2">Intercot </h1>
                <span class="text-sm lg:text-xl">Home Collection </span>
                <h2 class="text-base lg:text-2xl text-shadow">Textile Industrial Company based on Suez Freezone Area, <br>
                    Ataka, Suez, Egypt.</h2>
            ...
            <div>
                <div class='relative group '>
                    ...
                    <div class='bg-white h-full group-hover:bg-black relative overflow-hidden p-2 rounded rounded-lg z-10 shadow shadow-lg text-center'>
                        <img class="rounded rounded-lg " src="<?php echo get_template_directory_uri() ?>/assets/img/T2_5.jpg" alt="">
                    </div>
