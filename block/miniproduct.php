        ...
        <div class="grid lg:grid-cols-6 gap-6">
                ...
                <a href="/product">
                    ...
                    <div class='bg-white relative h-full group-hover:bg-black relative overflow-hidden p-2 rounded rounded-lg z-10 shadow shadow-lg text-center'>
                        ...
                        <span style="width: 96%;" class="absolute rounded rounded-lg block left-0 bottom-0 text-center bg-gradient-to-t from-gray-900 m-2 text-white pb-4 pt-24">
                            <span class="block">PILLOWS</span></span>
                    </div>
            ...
            <div class='relative group '>
                <a href="/product">
                    ...
                    <div class='bg-white h-full group-hover:bg-black relative overflow-hidden p-2 rounded rounded-lg z-10 shadow shadow-lg text-center'>
                        <img class="group-hover:scale-105 transform  transition duration-300 ease-in-out  rounded rounded-lg" src="<?php echo get_template_directory_uri() ?>/assets/img/x1.jpg" alt="">
                        <span style="width: 96%;" class="absolute rounded rounded-lg block left-0 bottom-0 text-center bg-gradient-to-t from-gray-900 m-2 text-white pb-4 pt-24">
                            <span class="block">PILLOWS</span></span>
                    </div>
            ...
            <div class='relative group '>
                <a href="/product">
                    ...
                    <span class="bg-main inline-block absolute top-0 left-0 w-full h-full transform z-0  rotate-3 transition duration-300 ease-in-out group-hover:rotate-0 rounded rounded-lg  "></span>
                    <div class='bg-white h-full group-hover:bg-black relative overflow-hidden p-2 rounded rounded-lg z-10 shadow shadow-lg text-center'>
                        <img class="group-hover:scale-105 transform  transition duration-300 ease-in-out  rounded rounded-lg" src="<?php echo get_template_directory_uri() ?>/assets/img/x2.jpg" alt="">
                        <span style="width: 96%;" class="absolute rounded rounded-lg block left-0 bottom-0 text-center bg-gradient-to-t from-gray-900 m-2 text-white pb-4 pt-24">
                            <span class="block">PILLOWS</span></span>
                    </div>
            ...
            <div class='relative group '>
                <a href="/product">
                    ...
                    <span class="bg-main inline-block absolute top-0 left-0 w-full h-full transform z-0  rotate-3 transition duration-300 ease-in-out group-hover:rotate-0 rounded rounded-lg  "></span>
                    <div class='bg-white h-full group-hover:bg-black relative overflow-hidden p-2 rounded rounded-lg z-10 shadow shadow-lg text-center'>
                        <img class="group-hover:scale-105 transform  transition duration-300 ease-in-out  rounded rounded-lg" src="<?php echo get_template_directory_uri() ?>/assets/img/x3.jpg" alt="">
                        <span style="width: 96%;" class="absolute rounded rounded-lg block left-0 bottom-0 text-center bg-gradient-to-t from-gray-900 m-2 text-white pb-4 pt-24">
                            <span class="block">PILLOWS</span></span>
                    </div>
            ...
            <div class='relative group '>
                <a href="/product">
                    ...
                    <span class="bg-main inline-block absolute top-0 left-0 w-full h-full transform z-0  rotate-3 transition duration-300 ease-in-out group-hover:rotate-0 rounded rounded-lg  "></span>
                    <div class='bg-white h-full group-hover:bg-black relative overflow-hidden p-2 rounded rounded-lg z-10 shadow shadow-lg text-center'>
                        <img class="group-hover:scale-105 transform  transition duration-300 ease-in-out  rounded rounded-lg" src="<?php echo get_template_directory_uri() ?>/assets/img/x4.jpg" alt="">
                        <span style="width: 96%;" class="absolute rounded rounded-lg block left-0 bottom-0 text-center bg-gradient-to-t from-gray-900 m-2 text-white pb-4 pt-24">
                            <span class="block">PILLOWS</span></span>
                    </div>
