...
<section class="bg-white overflow-hidden">
  <div class="relative container mx-auto pt-20 pb-12 px-4 sm:px-6 lg:px-8 lg:py-20">
    ...
    <div class="relative lg:flex lg:items-center">
      <div class="hidden lg:block lg:flex-shrink-0">
        <img class="h-64 w-64 rounded-full xl:h-80 xl:w-80" src="<?php echo $image ?>" alt="">
      </div>
          ...
          <footer class="mt-8">
            <div class="flex">
              ...
              <div class="ml-4 lg:ml-0">
                ...
                <div class="text-base font-medium text-indigo-600"><?php echo $title ?></div>
              </div>
            </div>
          </footer>
        </blockquote>
